...
var NpmUtilities = function () {
  ...
  _createClass(NpmUtilities, null, [{
    key: "installInDir",
    value: function installInDir(directory, dependencies, config, npmGlobalStyle, callback) {
      ...
      _FileSystemUtilities2.default.rename(packageJson, packageJsonBkp, function (err) {
        ...
        (0, _writePkg2.default)(packageJson, tempJson).then(function () {
          ...
          var opts = NpmUtilities.getExecOpts(directory, config.registry);
          var args = ["install"];
          var cmd = config.npmClient || "npm";
          ...
          if (config.npmClientArgs && config.npmClientArgs.length) {
            args.push.apply(args, _toConsumableArray(config.npmClientArgs));
          }

          _npmlog2.default.silly("installInDir", [cmd, args]);
          _ChildProcessUtilities2.default.exec(cmd, args, opts, done);
        }).catch(done);
      });
    }
  }, {
    key: "installInDirOriginalPackageJson",
    value: function installInDirOriginalPackageJson(directory, config, npmGlobalStyle, callback) {
      _npmlog2.default.silly("installInDir", _path2.default.basename(directory));
      ...
      _npmlog2.default.silly("installInDir", packageJson);
      ...
      _npmlog2.default.silly("installInDir", [cmd, args]);
      _ChildProcessUtilities2.default.exec(cmd, args, opts, callback);
    }
  }, {
    key: "addDistTag",
