...
import { Row, Spacer, ValueWrapper, Centered } from '@react-frontend-developer/react-layout-helpers'
  ...
  render () {
    return (
      <WithStore
        ...
        {
          ({ balance, channelReady, telepathInProgress, telepathError, dialogOpen }, dispatch) =>
            <Centered>
